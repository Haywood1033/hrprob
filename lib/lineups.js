...
// IDs verified from live MLB Stats API schedule responses
const VENUE_COORDS = {
  ...
  2602: { lat:39.097, lon:-84.507,  city:'Cincinnati',      roof:'open'        }, // Great American Ball Park
  ...
  4:    { lat:41.830, lon:-87.634,  city:'Chicago',         roof:'open'        }, // Rate Field (White Sox)
  32:   { lat:43.028, lon:-87.971,  city:'Milwaukee',       roof:'retractable' }, // American Family Field
  5355: { lat:36.193, lon:-115.138, city:'Las Vegas',       roof:'open'        }, // Las Vegas Ballpark (Athletics)
  10:   { lat:38.580, lon:-121.503, city:'West Sacramento', roof:'open'        }, // Sutter Health Park (Athletics primary)
  ...
  5:    { lat:41.496, lon:-81.685,  city:'Cleveland',       roof:'open'        }, // Progressive Field
  // Additional stadiums
  15:   { lat:39.756, lon:-104.994, city:'Denver',          roof:'open'        }, // Coors Field
  17:   { lat:41.948, lon:-87.655,  city:'Chicago',         roof:'open'        }, // Wrigley Field
  19:   { lat:39.756, lon:-104.994, city:'Denver',          roof:'open'        }, // Coors alt ID
  22:   { lat:34.074, lon:-118.240, city:'Los Angeles',     roof:'open'        }, // Dodger Stadium
  2394: { lat:39.097, lon:-84.507,  city:'Cincinnati',      roof:'open'        }, // GABP alt ID
  ...
  4321: { lat:41.830, lon:-87.634,  city:'Chicago',         roof:'open'        }, // Rate Field alt ID
  ...
  2500: { lat:32.751, lon:-97.082,  city:'Arlington',       roof:'retractable' }, // Globe Life Field
